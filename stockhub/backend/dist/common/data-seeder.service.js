...
var DataSeederService_1;
var _a;
Object.defineProperty(exports, "__esModule", { value: true });
exports.DataSeederService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const category_entity_1 = require("../modules/categories/entities/category.entity");
let DataSeederService = DataSeederService_1 = class DataSeederService {
    constructor(categoriesRepository) {
        this.categoriesRepository = categoriesRepository;
        this.logger = new common_1.Logger(DataSeederService_1.name);
    }
    async onModuleInit() {
...
exports.DataSeederService = DataSeederService;
exports.DataSeederService = DataSeederService = DataSeederService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(category_entity_1.Category)),
    __metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object])
], DataSeederService);
//# sourceMappingURL=data-seeder.service.js.map